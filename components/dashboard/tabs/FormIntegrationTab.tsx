            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    <p className="text-sm text-on-surface-variant">
                        POST JSON or form data to the endpoint below. CORS is enabled for all origins.
                    </p>

                    <div>
                        <h4 className="label-caps text-on-surface-variant mb-2">Endpoint</h4>
                ...
                <CardContent>
                    <dl className="divide-y divide-border-muted">
                        <div className="flex items-start gap-4 py-2.5">
                            <dt className="label-caps text-on-surface-variant w-32 shrink-0">slug</dt>
                            <dd className="text-sm text-on-surface">Your form&apos;s unique slug (required)</dd>
                        </div>
                        <div className="flex items-start gap-4 py-2.5">
                            <dt className="label-caps text-on-surface-variant w-32 shrink-0">formId</dt>
                            <dd className="text-sm text-on-surface">Form ID as alternative to slug</dd>
                        </div>
                        <div className="flex items-start gap-4 py-2.5">
                            <dt className="label-caps text-on-surface-variant w-32 shrink-0">Content-Type</dt>
                            <dd className="text-sm text-on-surface">
                                <code className="rounded bg-surface-container-highest px-1.5 py-0.5 text-xs font-mono">application/json</code> or
                                {" "}<code className="rounded bg-surface-container-highest px-1.5 py-0.5 text-xs font-mono">multipart/form-data</code>
                            </dd>
                        </div>
                        <div className="flex items-start gap-4 py-2.5">
                            <dt className="label-caps text-on-surface-variant w-32 shrink-0">Response</dt>
                            <dd className="text-sm text-on-surface">
                                <code className="rounded bg-surface-container-highest px-1.5 py-0.5 text-xs font-mono">201 {'{ "success": true }'}</code> (JSON) or
                                {" "}303 redirect to success page (form)
                            </dd>
                        </div>
                    </dl>
                </CardContent>
