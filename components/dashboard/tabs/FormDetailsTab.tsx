        ...
        <div className="space-y-6">
            <Card>
                <CardContent className="pt-6">
                    <Descriptions
                        column={{ xs: 1, sm: 2 }}
                        classNames={{ label: "!text-on-surface-variant !font-normal !text-sm" }}
                    >
                        <Descriptions.Item label={<span className="label-caps">Title</span>}>
                        ...
                        <Descriptions.Item label={<span className="label-caps">Submissions</span>}>
                            <span className="text-on-surface font-bold">{submissionCount}</span>
                        </Descriptions.Item>
                    </Descriptions>
                </CardContent>
            </Card>
